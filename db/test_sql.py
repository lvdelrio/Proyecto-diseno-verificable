...
def test_sql():
    ...
    curso = Curso(nombre="Física II", descripcion="Curso de Física II", semestre_impartido=1)
    requisito = Curso(nombre="Física I", descripcion="Curso de Física I", semestre_impartido=2)
